 ...
 */
import { app, BrowserWindow, Menu, Tray, Notification, globalShortcut, ipcMain, shell, nativeImage, dialog, } from "electron";
...
app.whenReady().then(async () => {
    try {
        ...
        dialog.showErrorBox("you2ube failed to start", err.message);
        app.quit();
    }
});
